<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeR2.aspx.cs" Inherits="WebApplication6.HomeR2" %>
<!DOCTYPE html>
...
<head>
   <script type="text/javascript">
     function DisableEnable() {
            ...
            setTimeout(function () { document.getElementById("Plant1Start").disabled = false; }, 5000);
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Plant1Stop" runat="server" Text="Stop" OnClick="Plant1Stop_Click" />
            </td>
            <td class="auto-style5">
                <asp:Button ID="Plant2Start" runat="server" Text="Start" OnClick="Plant2Start_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Plant2Stop" runat="server" Text="Stop" OnClick="Plant2Stop_Click" />
            </td>
            <td class="auto-style7">
                <asp:Button ID="Plant3Start" runat="server" Text="Start" OnClick="Plant3Start_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Plant3Stop" runat="server" Text="Stop" OnClick="Plant3Stop_Click" />
            </td>
            <td class="auto-style9">
                <asp:Button ID="Plant4Start" runat="server" Text="Start" OnClick="Plant4Start_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Plant4Stop" runat="server" Text="Stop" OnClick="Plant4Stop_Click" />
            </td>
            <td class="auto-style9">
                <asp:Button ID="Plant5Start" runat="server" Text="Start" OnClick="Plant5Start_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Plant5Stop" runat="server" Text="Stop" OnClick="Plant5Stop_Click" />
            </td>
        </tr>
        <tr>
            <td class="auto-style3">
